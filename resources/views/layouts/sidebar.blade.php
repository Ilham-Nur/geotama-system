                  ...
                  <a href="{{ route('surat-tugas.index') }}">
                      <span class="icon">
                          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                              xmlns="http://www.w3.org/2000/svg">
                              <path
                                  d="M10.1732 17.3305L7.93911 19.0708V21.2499L12.0003 19.5874L16.0614 21.2499V19.0708L13.8268 17.3301L14.0112 13.6483L20 14.5995V12.0682L14.2271 9.33902L14.2505 8.87272C14.3557 6.77192 13.7353 4.69883 12.4932 3.00124C12.2491 2.66755 11.7509 2.66755 11.5068 3.00124C10.2648 4.69883 9.64431 6.77191 9.74955 8.87272L9.77291 9.33901L4 12.0682V14.5995L9.98878 13.6483L10.1732 17.3305Z"
                      ...
                      <a href="{{ route('employees.index') }}">
                          <span class="icon">
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                  xmlns="http://www.w3.org/2000/svg">
                                  <path
                                      d="M7.5 7.5C7.5 5.84315 8.84315 4.5 10.5 4.5C12.1569 4.5 13.5 5.84315 13.5 7.5C13.5 9.15685 12.1569 10.5 10.5 10.5C8.84315 10.5 7.5 9.15685 7.5 7.5Z"
                                      fill="currentColor" />
                                  <path
                                      d="M3.75 17.25C3.75 14.7647 5.76472 12.75 8.25 12.75H12.75C15.2353 12.75 17.25 14.7647 17.25 17.25C17.25 17.6642 16.9142 18 16.5 18H4.5C4.08579 18 3.75 17.6642 3.75 17.25Z"
                                      fill="currentColor" />
                                  <path
                                      d="M16.5 8.25C16.5 6.80025 17.6753 5.625 19.125 5.625C20.5747 5.625 21.75 6.80025 21.75 8.25C21.75 9.69975 20.5747 10.875 19.125 10.875C17.6753 10.875 16.5 9.69975 16.5 8.25Z"
                                      fill="currentColor" opacity="0.5" />
                                  <path
                                      d="M18 13.5H20.25C21.4926 13.5 22.5 14.5074 22.5 15.75V17.25C22.5 17.6642 22.1642 18 21.75 18H18"
                                      fill="currentColor" opacity="0.5" />
                              </svg>
                          </span>
